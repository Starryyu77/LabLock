...
Next hardening target: dogfood the experiment dashboard in a real multi-experiment repo, then run controlled dogfood for 3-5 days and fix the highest-friction `scope.lock`, hook, dashboard, and audit issues before expanding probe templates or claim/paper parsing.
