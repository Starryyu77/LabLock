...
Next hardening target: dogfood `/lab-migrate` plus the experiment dashboard in a real legacy multi-experiment repo, then fix the highest-friction import-table, low-confidence mirror-node, `scope.lock`, hook, dashboard, and audit issues before expanding probe templates or claim/paper parsing.
